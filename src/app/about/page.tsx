...
export const metadata: Metadata = {
  title: '私たちについて',
  description: '零元創匠は東京都新宿区のシステム開発会社です。代表の根岸優翔が率いる技術集団で、基幹システム開発、Webアプリケーション開発、業務効率化ツールの開発を行っています。',
  openGraph: {
    title: '私たちについて | 零元創匠',
    description: '零元創匠は東京都新宿区のシステム開発会社です。基幹システム開発、Webアプリケーション開発、業務効率化ツールの開発を行っています。',
    url: 'https://www.reigen-soushou.com/about',
    type: 'website',
  },
  alternates: {
    canonical: 'https://www.reigen-soushou.com/about',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "私たちについて", "item": "https://www.reigen-soushou.com/about" }
  ]
};
...
const localBusinessSchema = {
  ...
  "description": "零元創匠は東京都新宿区のシステム開発会社です。基幹システム開発、Webアプリケーション開発、業務効率化ツールの開発を提供する技術集団です。代表の根岸優翔を中心に、お客様の業務課題を解決します。",
  "url": "https://www.reigen-soushou.com/about",
  "address": {
    "@type": "PostalAddress",
  ...
  return (
    <main style={{ maxWidth: '800px', margin: '0 auto', padding: '8px' }}>
        ...
        <tbody>
          <tr>
            <td style={{ backgroundColor: '#000080', color: '#ffffff', padding: '4px 8px', fontWeight: 'bold', fontSize: '18px', textAlign: 'center' }}>
              <h1 style={{ fontSize: '18px', margin: 0, color: '#ffffff' }}>■ 私たちについて ■</h1>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <p style={{ textAlign: 'center', fontSize: '13px', marginBottom: '16px' }}>
        零元創匠は東京都新宿区のシステム開発会社です。「零から始まるイノベーション」をモットーに、基幹システム開発、Webアプリケーション開発、業務効率化ツールの開発を行っています。
      </p>

      <hr />

      {/* 会社情報テーブル */}
      <section aria-label="事業者情報">
